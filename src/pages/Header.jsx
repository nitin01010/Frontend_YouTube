...
//         <span className='hover:bg-[#212121]  transition-all cursor-pointer ease-linear min-w-[40px] w-[40px] h-[40px] rounded-full flex items-center justify-center'>
//           <Video size={30} />
//         </span>
//         <span className='hover:bg-[#212121]    transition-all cursor-pointer ease-linear min-w-[40px] w-[40px] h-[40px] rounded-full flex items-center justify-center'>
//           <Bell size={28} />
...
//           alt="Fallback"
//           className=" w-[40px] h-[40px] hover:bg-[#212121]    transition-all cursor-pointer ease-linear m-auto mb-3  mt-3 object-cover rounded-full"
//         />
//       </div>
//       <div
//         className={`bg-gray-900 shadow-2xl top-15  w-[190px] rounded-md p-3 absolute right-2 transition-all duration-500 ease-in-out transform ${status ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5 pointer-events-none'
//           }`}
//       >
//         <img
//           src={user.userId?.avatar[0] || 'https://img.icons8.com/?size=100&id=bOXN3AZhMCek&format=png&color=000000'}
...
//         <p className=' text-center text-sm py-2 capitalize font-bold'>{user.userId?.email}</p>
//         <button onClick={handleClear} className=' w-full bg-white rounded-md h-[40px] text-black font-bold text-sm'>Logout</button>
//       </div>
...
const IconsData = [
  ...
  { id: 4, text: 'You', iconImageUrl: 'https://img.icons8.com/ios/50/FFFFFF/user-male-circle--v1.png', path: '/' },
];
